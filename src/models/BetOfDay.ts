...
export interface IBetOfDay extends Document { date:string; matchId:Types.ObjectId; prediction:string; confidence:number; risk:string; analysis:string; model:string; status:BetOfDayStatus; result?:'won'|'lost'|'void'; createdAt:Date; updatedAt:Date; }
